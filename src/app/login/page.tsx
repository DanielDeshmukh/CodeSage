      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-hairline bg-surface p-8">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-hairline bg-surface-elevated px-6 py-3 text-sm font-semibold text-ink transition-colors hover:bg-surface-hover"
          >
