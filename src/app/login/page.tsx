    ...
    <div className="flex min-h-screen items-center justify-center bg-canvas-dark p-8">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-on-dark">Welcome back</h1>
        ...
        <div className="rounded-lg border border-hairline bg-surface p-8">
          {error && (
            <div className="mb-6 rounded border border-danger/30 bg-danger/10 px-4 py-3 text-sm text-danger">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-hairline bg-surface-elevated px-6 py-3 text-sm font-semibold text-on-dark transition-colors hover:bg-surface-hover"
          >
    ...
    <Suspense
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-canvas-dark">
          <div className="h-10 w-10 animate-spin rounded-full border-4 border-surface-elevated border-t-primary" />
        </div>
      }
    >
      <LoginForm />
